          ...
          <FlatList
            ...
            ListHeaderComponent={() => (
              <View style={styles.feynmanIntro}>
                <View style={[styles.feynmanIcon, { backgroundColor: colors.primary + "15" }]}>
                ...
                {feynmanLocked ? (
                  ...
                  >
                    ...
                    <View style={{ flex: 1 }}>
                      <Text style={[styles.lockTxt, { color: colors.primary, fontFamily: "Inter_600SemiBold" }]}>
                        Daily limit reached
                      </Text>
                      <Text style={[styles.lockSubTxt, { color: colors.textSecondary, fontFamily: "Inter_400Regular" }]}>
