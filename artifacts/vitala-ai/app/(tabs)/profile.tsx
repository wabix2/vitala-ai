...
const ACHIEVEMENTS = [
  { id: "1", icon: "flame" as const, label: "7-Day Streak", unlocked: true, color: "#FF9600" },
  { id: "2", icon: "school" as const, label: "Quick Learner", unlocked: true, color: "#5C5EF0" },
  { id: "3", icon: "trophy" as const, label: "Top 10", unlocked: true, color: "#F59E0B" },
  { id: "4", icon: "book" as const, label: "Bookworm", unlocked: false, color: "#2DD4BF" },
  { id: "5", icon: "star" as const, label: "XP Master", unlocked: false, color: "#F59E0B" },
  { id: "6", icon: "bulb" as const, label: "Feynman Pro", unlocked: false, color: "#00C899" },
];
      ...
      <View style={styles.achieveGrid}>
        {ACHIEVEMENTS.map((a) => (
          <Pressable
            ...
            onPress={() => a.unlocked && Haptics.impactAsync(Haptics.ImpactFeedbackStyle.Light)}
          >
            <View style={[styles.achieveIcon, { backgroundColor: a.color + "22" }]}>
              <Ionicons name={a.icon} size={20} color={a.unlocked ? a.color : colors.textMuted} />
            </View>
            <Text
              style={[
                styles.achieveLabel,
                {
                  color: a.unlocked ? colors.text : colors.textMuted,
