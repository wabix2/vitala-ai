 ...
 */
export const syncPlayer = async (playerInput: PlayerInput, options?: RequestInit): Promise<LeaderboardEntry> => {

  return customFetch<LeaderboardEntry>(getSyncPlayerUrl(),
  {
    ...options,
    method: 'POST',
...
export const getSyncPlayerMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof syncPlayer>>, TError,{data: BodyType<PlayerInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof syncPlayer>>, TError,{data: BodyType<PlayerInput>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof syncPlayer>>, {data: BodyType<PlayerInput>}> = (props) => {
          const {data} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type SyncPlayerMutationResult = NonNullable<Awaited<ReturnType<typeof syncPlayer>>>
    export type SyncPlayerMutationBody = BodyType<PlayerInput>
    export type SyncPlayerMutationError = ErrorType<unknown>

    /**
 * @summary Sync player stats
 */
export const useSyncPlayer = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof syncPlayer>>, TError,{data: BodyType<PlayerInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
